...
from object_detector.YOLOv3.detector_yolov8 import inference_yolov8
...
def video():
    ...
    print("Person Instance detection in progress ...")
    video_candidates = {}
    for index, images_dir in tqdm(enumerate(input_image_save_dirs)):
        ...
        for image_path in tqdm(image_list):
            candidate_bbox = inference_yolov8(image_path)
    ...
    print("Person Instance detection finish")
    ...
    print("Single person pose estimation in progress ...")
